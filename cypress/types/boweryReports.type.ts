...
export namespace BoweryReports {
    ...
    export namespace FindComps {
        ...
        export type CompStatusValues = typeof Enums.COMP_STATUS_VALUES_FROM_STATUS_DROPDOWN.statusesFromStatusDropdown[
            KeyInfo.CompStatusValues]
        export type CompStatusValuesFromCompsList = typeof Enums.COMP_STATUS_VALUES_FROM_COMPS_LIST
            .statusesFromCompsList[KeyInfo.CompStatusValuesFromList]
    }
