import reportTitlesEnum from "./reportTitles.enum";
import propertyTitlesEnum from "./propertyTitles.enum";
import Income from "./income";
import SalesTitlesEnum from "./salesTitles.enum";
...
export const _IncomeTitles = Income;
export const _SalesTitles = SalesTitlesEnum;
export const _FinalTitles = finalTitlesEnum;
