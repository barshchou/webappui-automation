...
class SourceInformationPage extends BasePage {
    ...
    get deferredMaintenanceSources() {return cy.get(`[data-qa='Deferred Maintenance-row'] ${this.sourceLabelLocator}`);}
    ...
    get comparableRentalDataSources() {return cy.get(`[data-qa='Comparable Rental Data-row'] ${this.sourceLabelLocator}`);}

    get comparableSalesDataSources() {return cy.get(`[data-qa='Comparable Sales Data-row'] ${this.sourceLabelLocator}`);}
}
