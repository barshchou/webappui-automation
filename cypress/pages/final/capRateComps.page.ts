...
class CapRateCompsPage extends BasePage {
    ...
    get selectStateDropdown() {return cy.get("[data-qa='search.locationIdentifier-select-list'] [data-qa=select-value]");}
    ...
    get comparablesTypesDrops() {return cy.get("[data-qa^=capRateComps][data-qa$=type-select-list] [data-qa=select-value]");}
    ...
    get compsSaleDates() {return cy.get("[data-qa^=capRateComps][data-qa$=saleDate-date-picker] input:not([type=hidden])");}
    ...
    getElementToCheckRadio(radioValue) {return cy.get(`[data-qa=checked] [value=${radioValue}]`);}
