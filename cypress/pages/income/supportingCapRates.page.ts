...
class SupportingCapRatesPage extends BasePage {
    get personalSurveysOpenSectionButton() {return cy.get("[data-qa=personal-surveys-ratio-section] > [role=button]");}
    ...
    get selectedLoanMortgageConstant() {return cy.get("[data-qa=selected-loan-terms-section] [name=mortgageConstant]");}
    ...
    get bandInvestmentMortgageConstant() {return cy.get("[data-qa=band-of-investment-section] [name=mortgageConstant]");}
