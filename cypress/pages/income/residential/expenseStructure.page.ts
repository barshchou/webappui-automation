...
class ExpenseStructurePage extends BasePage {
    ...
    getHeatExpensesToCheck(value: string) { 
        return cy.get(`[data-qa*="fuel"] [data-qa=checked] input[value='${value}']`); 
    }

    get electricityRadio() { return cy.get("[name='expenseStructure.electricity']"); }

    getElectricityToCheck(value: string) { 
        return cy.get(`[data-qa*="electricity"] [data-qa=checked] input[value='${value}']`); 
    }

    get commonElectricityRadio() { return cy.get("[name='expenseStructure.commonElectricity']"); }

    getCommonElectricityToCheck(value: string) { 
        return cy.get(`[data-qa*="commonElectricity"] [data-qa=checked] input[value='${value}']`); 
    }

    get gasExpensesRadio() { return cy.get("[name='expenseStructure.gas']"); }

    getGasToCheck(value: string) { return cy.get(`[data-qa*="gas"] [data-qa=checked] input[value='${value}']`); }

    get refuseRemovalRadio() { return cy.get("[name='expenseStructure.refuseRemoval']"); }

    getRefuseRemovalToCheck(value: string) { 
        return cy.get(`[data-qa*="refuseRemoval"] [data-qa=checked] input[value='${value}']`); 
    }

    get waterSewerRadio() { return cy.get("[name='expenseStructure.waterAndSewer']"); }

    getWaterSewerToCheck(value: string) { 
        return cy.get(`[data-qa*="waterAndSewer"] [data-qa=checked] input[value='${value}']`); 
    }

    get areaMaintenanceRadio() { return cy.get("[name='expenseStructure.commonAreaMaintenance']"); }

    getAreaMaintenanceToCheck(value: string) { 
        return cy.get(`[data-qa*="commonAreaMaintenance"] [data-qa=checked] input[value='${value}']`); 
    }
