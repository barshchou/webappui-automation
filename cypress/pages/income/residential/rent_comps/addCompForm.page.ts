...
class AddCompFormPage extends BasePage {
    ...
    getUnitTypeByValue(value: string) { return cy.get(`*[data-qa^='unitLayout'][data-value='${value}']`); }
    ...
    getDayOfCurrentMonthInPicker(day: string | number) { 
    ...
    get sourceOfInfoDropdown() { 
        return cy.get("*[data-qa='sourceOfInformation-select-list'] [data-qa='select-value']"); 
    }

    getSourceOfInfoByValue(value: string) { return cy.get(`*[data-qa^='sourceOfInformation'][data-value='${value}']`); }
    ...
    getCheckboxByDataQaAttr(attribute: string) { return cy.get(`*[data-qa='${attribute}'] input`); }
