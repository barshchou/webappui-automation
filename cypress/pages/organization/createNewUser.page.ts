...
class OrganizationCreateNewUserPage extends BasePage {
    ...
    get userPrefixField() { 
        return cy.xpath("//label[contains(text(), 'Prefix')]//following::*[@data-qa='select-value'][1]"); 
    }
    ...
    prefixSelectOption(prefix: BoweryReports.OrganizationAddresseePrefix) { 
        return cy.get(`[data-qa="prefix-${prefix}-select-option"]`); 
    }
}
