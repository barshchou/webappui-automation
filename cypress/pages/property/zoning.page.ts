...
class ZoningPage extends BasePage{
    ...
    getRowCancelButtonByRegulationValue(value) {
        return cy.xpath(`//input[@value='${value}']//ancestor::td//following-sibling::td[@data-qa='remove-cell']//child::button`);
    }
    ...
    get parkingResidentalUnits() {return cy.get("[data-qa='parkingTable-residentialUnits']");}
