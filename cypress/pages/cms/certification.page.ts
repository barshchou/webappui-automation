...
class CertificationPage extends BasePage {
    certificationDiscussionSection(sectionName: ContentManagementSystem.CertificationSections) {
        return cy.xpath(`//h6[.='${sectionName}']//following::div[@data-slate-editor][1]`);
    }

    certificationModifiedLabel(sectionName: ContentManagementSystem.CertificationSections) {
