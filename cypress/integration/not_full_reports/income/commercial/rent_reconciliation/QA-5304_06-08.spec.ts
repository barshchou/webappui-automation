...
describe(`Verify the "Lease Terms Adjustment Sub-Total"`, 
    ...
    it(`[QA-5304] Verify the "Lease Terms Adjustment Sub-Total" row is displayed in the "Rent Reconciliation" grid
        ...
        cy.stepInfo(`4. Enter any value into the input field of the “Market Conditions Adjustment” row for any added comparable (e.g. 5%)`);
        ...
        cy.stepInfo(`[QA-5306] 5. Verify that the “Lease Terms Adjustment Sub-Total” is calculated as Rent/SF + Lease Terms Adjustment`);
        for (let index = 0; index < testData.numberOfComparables; index++) {
        ...
        cy.stepInfo(`[QA-5307] 7. Verify the calculations for the “Lease Terms Adjustment Sub-Total” row (Rent/SF + Lease Terms Adjustment)`);
        for (let index = 0; index < testData.numberOfComparables; index++) {
