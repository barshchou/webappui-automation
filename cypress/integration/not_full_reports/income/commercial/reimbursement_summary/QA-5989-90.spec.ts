...
describe(`Income > Commercial > Reimbursement Summary - 
Verify Gross and Annual values for added Utilities reimbursements`,
{ tags: [ "@income", "@commercial", "@reimbursement_summary" ] }, () => {
    ...
    before("Login, create report", () => {
        ...
        cy.stepInfo(`5. Go to Income > Expense History page and 
