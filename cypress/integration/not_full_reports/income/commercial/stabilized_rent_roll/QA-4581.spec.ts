...
describe("Verify the Save & Continue button functionality on the Stabilized Rent Roll page:", () => {
    ...
    it("Test body", () => {
        ...
        Income._CommercialManager.StabilizedRentRoll.verifyThatPageIsOpened(Income._CommercialManager.StabilizedRentRoll.Page.stabilizedRentRollheaderSection, testData.firstVerifyUrl)
        ...
        Income._MiscellaneousManager.Laundry.verifyThatPageIsOpened( Income._MiscellaneousManager.Laundry.Page.laundryheaderSection, testData.secondVerifyUrl);
