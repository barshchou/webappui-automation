...
describe("[QA-4088], [QA-4089], [QA-4090] [QA-4091] 'What time period should rent PSF be based on?' radiobuttons and label functionality",
    { tags: [ "@income", "@residential", "@in_place_rent_roll" ] }, () => {
        ...
        it("[QA-4088]", () => {
            ...
            Income._Residential.InPlaceRentRoll.Page.getPerUnitSFRadio(testData.false).should("be.checked");
            Income._Residential.InPlaceRentRoll.checkPerUnitSquareFootage(testData.true);
        ...
        it("[QA-4089]", () => {
            ...
            Income._Residential.InPlaceRentRoll.checkPerUnitSquareFootage(testData.false);
