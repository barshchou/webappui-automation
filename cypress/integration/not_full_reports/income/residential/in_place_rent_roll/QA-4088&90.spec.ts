...
describe("Verify if 'Per Year' radiobutton is selected by default + 'What time period should rent PSF be based on?' question appears",
    { tags: [ Tag.income, Tag.residential, Tag.in_place_rent_roll ] }, () => {
        ...
        it("Test body", () => {
            ...
            cy.stepInfo(`3. [QA-4090] "Verify if  'Per Year' radiobutton is selected by default" `);
