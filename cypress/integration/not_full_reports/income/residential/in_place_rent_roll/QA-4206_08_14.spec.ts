...
describe("Verify the Developer's Forecast checkbox on the In-Place Rent Roll page", 
    ...
    it("[QA-4206_08_14] Test body, AS_IS Report", () => {
        cy.stepInfo("1. Login, create report");
        createReport(reportCreationData(testData.conclusionValues[0]));
        ...
        deleteReport(reportCreationData(testData.conclusionValues[0]).reportNumber);
    });

    it("[QA-4206_08_14] Test body, AS_STABILIZED Report", () => {
        cy.stepInfo("1. Login, create report");
        createReport(reportCreationData(testData.conclusionValues[0]));
    ...
    it("[QA-4206_08_14] Test body, AS_COMPLETE Report", () => {
        cy.stepInfo("1. Login, create report");
        createReport(reportCreationData(testData.conclusionValues[0]));
