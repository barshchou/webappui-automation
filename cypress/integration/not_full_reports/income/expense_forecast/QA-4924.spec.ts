...
describe("User selects Per SF radiobutton for Repairs & Maintenance on Expense Forecast form and historical expenses per SF are correctly calculated and displayed", 
    ...
    it("Test body", () => {
        ...
        Income.ExpenseForecast.Actions.matchElementSnapshot(
            Income.ExpenseForecast.Page.repairsAndMaintenanceCard.scrollIntoView(), testData.repairsAndMaintenanceCardSnapshotName,
            { padding: [ 10, 100 ], updatePassedSnapshot: true });
