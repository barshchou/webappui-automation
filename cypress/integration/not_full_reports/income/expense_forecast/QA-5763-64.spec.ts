...
describe("[QA-5763] [QA-5764] Appraiser's Forecast value for Legal & Professional Fees is correctly converted to Per SF/Unit value",
    { tags: [ "@income", "@expense_forecast" ] }, () => {
        ...
        it("[QA-5763] Per Unit Appraiser's Forecast value for Legal & Professional Fee is correctly converted to Per SF value", () => {
            ...
            cy.stepInfo("1. Go to Expense Forecast and make sure that Per Unit radiobutton is selected for Legal & Professional Fees card");
            ...
            Income._ExpenseForecastActions.enterForecastItemForecast(testData.expenseForecastLegalProfessionalFixture('unit'));
        ...
        it("[QA-5764] Per SF Appraiser's Forecast value for Legal & Professional Fees is correctly converted to Per Unit value", () => {

            cy.stepInfo("1. Go to Expense Forecast and make sure that Per SF radiobutton is selected for Legal & Professional card");
            _NavigationSection.Actions.navigateToExpenseForecast();
            ...
            cy.stepInfo("2. Fill in Appraiser's Forecast field for Legal & Professional Fees card");
            Income._ExpenseForecastActions.enterForecastItemForecast(testData.expenseForecastLegalProfessionalFixture('sf'));
