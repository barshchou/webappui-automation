...
describe(`Per SF Appraiser's Forecast value for Fuel is correctly converted to Per Unit value`,
    { tags: [ "@income", "@expense_forecast" ] }, () => {
        ...
        it(`[QA-5795]`, () => {
            ...
            Income._ExpenseForecastActions.chooseForecastItemBasis(testData.fuelPerSfItem);

            cy.stepInfo(`2. Fill in Appraiser's Forecast field for Fuel card`);
            Income._ExpenseForecastActions.enterForecastItemForecast(testData.fuelPerSfItem);
            ...
            Income._ExpenseForecastActions.verifyForecastItemBasisMoney(testData.fuelPerSfItem, 
