...
describe("Per Unit Appraiser's Forecast value for Insurance is correctly converted to Per SF value", () => {
    ...
    it("Test body", () => {
        ...
        cy.stepInfo("2. Go to Expense Forecast and make sure that Per Unit radiobutton is selected for Insurance card");
        ...
        Income.ExpenseForecast.verifyForecastItemBasisMoney(testData.insuranceItem, testData.buildingDescription);
