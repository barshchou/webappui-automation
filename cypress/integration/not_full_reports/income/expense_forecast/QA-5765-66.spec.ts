...
describe("[QA-5765] [QA-5766] Appraiser's Forecast value for Miscellaneous is correctly converted to Per SF/Unit value",
    { tags: [ "@income", "@expense_forecast" ] }, () => {
        ...
        it("[QA-5765] Per Unit Appraiser's Forecast value for Miscellaneous is correctly converted to Per SF value", () => {
            ...
            cy.stepInfo("1. Go to Expense Forecast and make sure that Per Unit radiobutton is selected for Miscellaneous card");
            ...
            Income._ExpenseForecastActions.enterForecastItemForecast(testData.expenseForecastMiscellaneousFixture('unit'));
        ...
        it("[QA-5766] Per SF Appraiser's Forecast value for Miscellaneous is correctly converted to Per Unit value", () => {

            cy.stepInfo("1. Go to Expense Forecast and make sure that Per SF radiobutton is selected for Miscellaneous card");
            _NavigationSection.Actions.navigateToExpenseForecast();
            ...
            cy.stepInfo("2. Fill in Appraiser's Forecast field for Miscellaneous card");
            Income._ExpenseForecastActions.enterForecastItemForecast(testData.expenseForecastMiscellaneousFixture('sf'));
