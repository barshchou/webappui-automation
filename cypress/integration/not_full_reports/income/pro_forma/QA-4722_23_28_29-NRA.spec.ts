    ...
    { tags:[ "@income", "@pro_forma" ] }, () => {
        ...
        before("Login, create report, prepare data", () => {
            cy.stepInfo(`1. Create new report or open the report which is already created. 
                    ...
                    Set square foot analysis basis to NRA and fill area`);
            createReport(testData.reportCreationData);
            _NavigationSection.navigateToSubjectPropertyData();
            DataCollections._SubjectPropertyData.selectBasisSquareFootAnalysis(testData.basisSquareFootAnalysis.nra)
        ...
        it("[QA-4723]", () => {
            cy.stepInfo(`5. The value in the Less Real Estate Taxes Reimbursement 
