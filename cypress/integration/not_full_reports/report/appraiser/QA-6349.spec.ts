...
import testData from "../../../../fixtures/not_full_reports/report/appraiser/QA-6349.fixture";

describe(`Verify the correct State is displayed in the State Certification after the user added a new appraiser
         who has a license for this state`, { tags:[ "@report", "@appraiser", "@check_export" ] }, () => {

    it("[QA-6349], NY report", () => {
        ...
        Report._Appraiser.verifyAppraiserStateCertification(testData.appraiserName, testData.states.newYork);
    });
    ...
    it("[QA-6349], Other report", () => {
        ...
        cy.stepInfo("3 Verify that the correct state for this NY property is displayed");
        Report._Appraiser.verifyAppraiserStateCertification(testData.appraiserName, testData.states.pennsylvania);
    });
});