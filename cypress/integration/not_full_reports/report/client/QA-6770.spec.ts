...
import testData from "../../../../fixtures/not_full_reports/report/client/QA-6770.fixture";
...
describe('Verify the display of the multiple clients on the Letter of Transmittal',
    { tags: [ "@report", "@client", "@check_export" ] }, () => {
        ...
        it("[QA-6770]", () => {
            ...
            cy.stepInfo(`5. Client 1, Client 2, Client 3 and Client 4 are displayed and separated by a comma in the 1 
        ...
        it('Check export', () => {
            cy.task("getFilePath", { _reportName: testData.reportFreddieMac.reportNumber, _docxHtml: "html" })
                .then(file => {
                    ...
                    cy.stepInfo("7. Verify values from step #5 in report");
                    testData.inputValues.forEach(value => {
