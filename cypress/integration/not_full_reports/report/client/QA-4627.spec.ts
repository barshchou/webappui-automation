...
describe("[QA-4627] Verify the functionality of the Client field.", () => {
    ...
    it("Test body", () => {
        ...
        // cy.stepInfo("4. Proceed to the Report > Client page and verify that a newly created client is added to the list by entering the first letter and can be selected.");
