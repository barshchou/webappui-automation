...
describe("[QA-4543][QA-4544][QA-4545][QA-4546][QA-4547] Verify the buttons functionality on Property > Commercial Units page.",
    { tags: [ "@property", "@commercial_units" ] }, () => {
        ...
        it("[QA-4544]", () => {
            ...
            cy.stepInfo("1. Click on the Cancel button and verify that the form closes form without saving changes with no warning message.");
