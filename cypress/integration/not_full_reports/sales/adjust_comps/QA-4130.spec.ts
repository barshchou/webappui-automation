...
describe("Adjusted Price per Residential Unit in Sales Adjustment Grid is calculated with correct formula", 
    ...
    it("Test body", () => {
        ...
        cy.stepInfo("3. Fill in Income > In-Place Rent Roll table for both Residential and Commercial with valid values, save the page");
        ...
        cy.stepInfo("4. Fill in Concluded Cap Rate on Income > Cap Rate Conclusion page. Make sure As Is Market Value is not negative value");
