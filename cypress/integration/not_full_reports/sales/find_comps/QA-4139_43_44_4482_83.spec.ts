...
conditionalDescribe("Group of tests for numeric inputs at create comp modal", 
    { tags:[ "@find_comps", "@sales" ] }, () => {
         ...
         */
            ...
            Sales._FindComps
                .verifyNumericInputNewComp(pageElements.comp_plex.createCompNumberResidentialUnits, 
                    testData.spec4139.numberOfUnitsDefault)
                .enterNumericInputNewComp(pageElements.comp_plex.createCompNumberResidentialUnits, 
        ...
        it(`QA-4143: Verify the #Commercial Units* field`, () => {        
            ...
            Sales._FindComps
                .enterNumericInputNewComp(pageElements.comp_plex.createCompNumberCommercialUnits, 
        ...
        it(`QA-4144: Verify the Commercial Area* field`, () => {
            ...
            Sales._FindComps
                .enterNumericInputNewComp(pageElements.comp_plex.commercialAreaNewComp, 
        ...
        it(`QA-4482: Verify the Net Rentable Area field`, () => {
            ...
            Sales._FindComps
                .enterNumericInputNewComp(pageElements.comp_plex.netRentableAreaNewComp, 
        ...
        it("QA-4483: Verify the Average Unit Size field", { tags:[ "@comp_plex" ] }, () => {
            ...
            Sales._FindComps
                .enterNumericInputNewComp(pageElements.comp_plex.averageUnitSizeNewComp, 
