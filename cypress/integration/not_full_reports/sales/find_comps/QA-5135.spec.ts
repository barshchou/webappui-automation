...
{ tags: [ "@sales", "@find_comps", "@comp_plex" ] }, () => {
    ...
    it("Test body", () => {
        ...
        cy.pause();
        cy.stepInfo(`
        4. [QA-5135] -> Order doesn’t change upon selection of “custom“ choice, 
        ...
        Sales._FindComps.checkSalesCompAddedToList({ reverse: true });


        cy.stepInfo(`5. 
        [QA-5135] 
        -> If user selected custom order at first, re-ordered comps and after that selected “Date Sold” sorting 
