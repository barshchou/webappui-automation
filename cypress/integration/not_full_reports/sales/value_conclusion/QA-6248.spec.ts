import testData from "../../../../fixtures/not_full_reports/sales/value_conclusion/QA-6248.fixture";
...
describe(`Prospective Market Value As Complete is calculated with correct formula`,
    { tags:[ "@sales", "@value_conclusion" ] }, () => {
        ...
        it("[QA-6248]", () => {
            cy.stepInfo(`9. Prospective Market Value As Complete (for ACAS report)-->Should be calculated with formula
                        Prospective Market Value As Complete (Amount) = Prospective Market Value As Stabilized (Amount)
                         - Less Residential Rent Loss - Less Commercial Rent Loss - Less Undetermined Commercial 
                        Rent Loss - Less Commission Fee - Less Entrepreneurial Profit*`);
            ...
            cy.stepInfo(`10. Verify that Prospective Market Value As Complete (Final Value) rounded correctly according 
                        to selection in “Round to nearest” on Income>Cap Rate Conclusion page`);
