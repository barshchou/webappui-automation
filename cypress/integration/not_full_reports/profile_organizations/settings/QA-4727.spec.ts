...
describe("[QA-4727] Verify possibility to edit static text in-app", { tags:[ "@organizations", "@settings" ] }, () => {
    ...
    it('Update static text in Settings and verify changes on a corresponding pages', () => {
        ...
        Organization._OrganizationSettingsActions.saveOrganizationSettings();
