...
import { Chips } from "../../data_chips/chips.fixture";
...
let chips = new Chips(_block, _buildingName, _grossBuildingArea, _lotValue, _numberOfCommercialUnits, _numberOfResidentialUnits,
                    _siteArea, _streetAddress, _streetName, _currentNumberOfCommercialUnits, _currentNumberOfResidentialUnits);
