...
const _squareFootAnalysisFixture = [
    ...
    },
    {
        ...
        area: 3000,
        distributionSummaryNoSquareFootage: "The gross leasable area and average square" + 
            " footage per unit was provided by the owner.",
        distributionSummaryYesSquareFootage: "The gross leasable area and square footage" + 
            " per unit was provided by the owner."
    },
    {
        name: "Net Rentable Area",
        basis: enums.BASIS_SQUARE_FOOT_ANALYSIS.netRentableArea,
        area: 3000,
        distributionSummaryNoSquareFootage: "The net rentable area and average square footage" +
            " per unit was provided by the owner.",
        distributionSummaryYesSquareFootage: "The net rentable area and square footage per" + 
            " unit was provided by the owner."
    },
    {
        name: "Net Leasable Area",
        basis: enums.BASIS_SQUARE_FOOT_ANALYSIS.netLeasableArea,
        area: 3000,
        distributionSummaryNoSquareFootage: "The net leasable area and average square footage" + 
            " per unit was provided by the owner.",
        distributionSummaryYesSquareFootage: "The net leasable area and square footage per" 
            + " unit was provided by the owner."
    }
];
