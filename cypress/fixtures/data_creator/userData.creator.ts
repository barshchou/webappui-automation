...
class UserCreator {
    ...
    getUserData(options?: BoweryAutomation.OrganizationCreateNewUserData) {
        ...
        options?.firstName == undefined ? this.setFirstName() : this.setFirstName(options.firstName);
        options?.middleName == undefined ? this.setMiddleName() : this.setMiddleName(options.middleName);
        options?.lastName == undefined ? this.setLastName() : this.setLastName(options.lastName);
        options?.userSuffix == undefined ? this.setUserSuffix() : this.setUserSuffix(options.userSuffix);
